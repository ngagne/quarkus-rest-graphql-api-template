...
Read template: `.qwen/get-shit-done/templates/UI-SPEC.md`
...
```bash
node ".qwen/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
