...
```bash
INIT=$(node ".qwen/get-shit-done/bin/gsd-tools.cjs" init manager)
...
Steps:
1. Read the plan-phase workflow: cat .qwen/get-shit-done/workflows/plan-phase.md
2. Run: node \".qwen/get-shit-done/bin/gsd-tools.cjs\" init plan-phase {N}
...
Steps:
1. Read the execute-phase workflow: cat .qwen/get-shit-done/workflows/execute-phase.md
2. Run: node \".qwen/get-shit-done/bin/gsd-tools.cjs\" init execute-phase {N}
